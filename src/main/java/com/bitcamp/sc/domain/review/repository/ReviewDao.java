...
public interface ReviewDao {
    ...
    // 02. 게시글 상세보기
     ReviewVO readReview(long idx) throws Exception;
    // 03. 게시글 수정
     int updateReview(ReviewVO vo) throws Exception;
    // 04. 게시글 삭제
     void deleteReview(long idx) throws Exception;
    // 05. 게시글 전체 목록
     List<ReviewVO> listAllReview() throws Exception;
    // 06. 게시글 좋아요
     int likeReview(ReviewVO vo) throws Exception;
	 ...
	 * // 06. 게시글 조회 증가 
	 * public void increaseViewcnt(long idx) throws Exception; 
	 */
